            ...
            for filename in files:
                if filename.endswith(ends_in % data_set.split('_')[0]):
                    ...
                    for object in objects:
                        if object['label'] not in category_instancesonly:
                        ...
                        ann['segmentation'] = [[i for p in object['polygon'] for i in p]]

                        if object['label'] not in category_dict:
                            category_dict[object['label']] = cat_id
                            cat_id += 1
                        ann['category_id'] = category_dict[object['label']]
                        ann['iscrowd'] = 0
                        ann['bbox'] = bbox.xyxy_to_xywh(
                            bbox.polys_to_boxes(
                                ann['segmentation'])).tolist()[0]
                        ann['area'] = bbox.pixelCount(object['polygon'], ann['bbox'])
...
if __name__ == '__main__':
    ...
    convert_cityscapes_instance_only('/home/littlebee/dataset/Cityscapes',
                                     '/home/littlebee/dataset/Cityscapes/annotations')
